              ...
              <Form onSubmit={handleSubmit(onSubmit)} >
                ...
                <Row form>
                  <Col md='4' className='form-group'>
                    <Selector nombre='tipodepersona_id' descripcion='Depende de' setValue={setValue} errores={errores} opciones={parametros['tipodepersona_id']} />
                  </Col>
                  <Col md='8' className='form-group'>
                    <LpInput nombre='tipodeidentificacion' descripcion='Nombre de Item' register={register} errores={errores} />
                  </Col>
                </Row>
