              ...
              <Form onSubmit={handleSubmit(onSubmit)} >
                ...
                <Row form>
                  ...
                  <Col md='8' className='form-group'>
                    <LpInput nombre='departamento' descripcion='Departamento' register={register} errores={errores} />
                  </Col>
                  <Col md='8' className='form-group'>
                    <LpInput nombre='codigo' descripcion='Codigo' register={register} errores={errores} />
                  </Col>
                </Row>
