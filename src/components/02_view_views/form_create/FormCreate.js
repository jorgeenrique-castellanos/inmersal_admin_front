...
import { Context } from "../../../views/02_view_views/helpers/context";
import { useForm, Controller } from "react-hook-form";
import InputText from "../../inputs/InputText";
import InputTextPrepend from "../../inputs/InputTextPrepend";
import InputTextAppend from "../../inputs/InputTextAppend";
                ...
                <Row form>
                  ...
                  <Col md="6" className="form-group">
                    <InputTextPrepend
                      register={register}
                      id={"bb"}
                      name={"input_text_prepend"}
                      labelText={"Input Text Prepend"}
                      defaultValue={null}
                      readOnly={false}
                      required={true}
                      placeHolder={"ejemplo"}
                  ...
                  <Col md="6" className="form-group">
                    <InputTextAppend
                      register={register}
                      id={"fdt"}
                      name={"input_text_append"}
                      labelText={"Input Text Append"}
                      defaultValue={null}
                      readOnly={false}
                      required={true}
