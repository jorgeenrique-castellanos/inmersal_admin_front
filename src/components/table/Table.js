...
export default function Table({ state, actions, params }) {
  ...
  //     tipodeoperacion in metodos
  //       ? metodos[tipodeoperacion](cellEdit)
  //       : setPeticion({
  //           tipodeoperacion,
  //           page,
  //           sizePerPage,
  ...
  //         actions.notificacion("error", errores.errors.join("\n"));
  //       });
  //   };
  ...
  //     if (tipo === "select") {
  //       registroactualizado = setValoresDeSelect(
  //         columnaactual,
  //         registroactual,
  //         newValue
  //       );
  //     } else {
  //       registroactualizado = setValoresDeInput(
  //         columnaactual,
  //         registroactual,
  //         newValue
  //       );
  ...
  //     const opcionseleccionada = _.find(opciones, function(o) {
  //       return o.value == newValue;
  //     });
  //     if (!opcionseleccionada) return registroactual;
  ...
  //     const filas = isSelect
  //       ? rowsmarked.concat(row[keyField])
  //       : rowsmarked.filter(key => key != row[keyField]);
  ...
  //     _.isEmpty(estado.rowsmarked)
  //       ? actions.notificacion("error", mensaje)
  //       : mostrarModalConfirmacion(true);
  //     actions.borradoreset();
  //   };
  ...
  //     return respuesta.data.status === "Success"
  //       ? borradoExitoso(respuesta)
  //       : actions.notificacion("error", respuesta.data.message);
  //   }
  ...
  //     estado.rowschanged
  //       ? mostrarModalConfirmacionChange(true)
  //       : actions.notificacion("error", mensaje);
  //     actions.cambiareset();
  //   };
  ...
  //     return parametros["beforeSaveCell"]
