...
import { Context } from "../../../views/09_view_project_List_Finishes/helpers/context";
                ...
                <Row form>
                  <Col md="6" className="form-group">
                    <InputText
                      ...
                      labelText={"Espacio"}
                      required={!false}
                      placeHolder={"Escriba el espacio"}
                      maxLength={50}
                  ...
                  <Col md="6" className="form-group">
                    <InputImage
                      id={"finished_image_1"}
                      name={"finished_image_1"}
                      labelText={"Imagen sin acabado"}
                      required={true}
                      setArchivos={setArchivos}
                      titulo="Arrastre o click en su imagen"
                      archivos={3}
                    />
                  </Col>
                  <Col md="6" className="form-group">
                    <InputImage
                      id={"finished_image_2"}
                      name={"finished_image_2"}
                      labelText={"Imagen con acabado"}
                      required={true}
                      setArchivos={setArchivos}
                      titulo="Arrastre o click en su imagen"
                      archivos={3}
